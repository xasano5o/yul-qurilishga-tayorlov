...
import { useDeleteDirectionMutation } from "../../redux/slice/direction/index.js";

export default function DeleteYunalish({ ID, }) {
    const [isOpen, setIsOpen] = useState(false);
    const closeModal = () => setIsOpen(!isOpen);
    const [deleteTeacher, { isLoading }] = useDeleteDirectionMutation();
